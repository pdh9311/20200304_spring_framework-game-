			...
			side: {
						...
						navigation: function() {
									$(".nav-left a").on("touchstart click", function(e) {
												...
												var th = $(this).attr("href").replace("#list", ""); 
										
												if("game" == th ){
													$(".sidebar").toggleClass("active"), $(".html").removeClass("visible"), 
															location.href = "game/gameList";
												}else if( "board" == th ){
													$(".sidebar").toggleClass("active"), $(".html").removeClass("visible"), 
													 location.href =  "board/list";
												}else if("home" == t || "" == t || null == t){
													$(".html.welcome").addClass("visible") , $(".html." + t).addClass("visible")
												}
