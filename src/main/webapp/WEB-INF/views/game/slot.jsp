...
<div id="buttons">
	...
	<input id="table_toggle" type="button" value="Table" onclick="javascript:$('#list').toggle('fast');"/>
...
<br/> <br/>
	<table id="list" style="text-align: center;">
		<tr>
			<td><img src="/resources/img2/0.png"/></td>
			<td><img src="/resources/img2/1.png"/></td>
			<td><img src="/resources/img2/2.png"/></td>
			<td><img src="/resources/img2/3.png"/></td>
			<td><img src="/resources/img2/4.png"/></td>
			<td><img src="/resources/img2/5.png"/></td>
		</tr>
		<tr>
			<td><h6>x10</h6></td>
			<td><h5>x20</h5></td>
