...
<div id="chatting_board" style="border: 2px black solid; width: 400px; height: 300px; float:left; "><!--margin: 0px 20px 0px 40px;  -->
	...
	<input type="text" id="chat" style="margin-left: 8px; margin-top: 3px; width: 300px;"/>
...
<div id="winnerDiv">winner :  </div>
		...
		<input type="number" id="horsecancel"/>
...
/////////////////////////////////////////////////////////////////////////////////////
            ...
            socket.on("chat", function(data){
				...
				$("#calc").click(function() {
					...
					$.ajax({
              			type : "get",
              			url : contextPath+"/horse/betclose",
              			success : function(data){
              				alert(data);
              			},
              			erro : function(res){
